...
run_prompt "Summary test 1: ${payload}"
run_prompt "Summary test 2: ${payload}"
run_prompt "Summary test 3: ${payload}"
run_prompt "Summary test 4: ${payload}"
run_prompt "Summary test 5: ${payload}"
run_prompt "Summary test 6: ${payload}"
